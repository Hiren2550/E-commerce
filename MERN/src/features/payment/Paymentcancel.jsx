  ...
  return (
    <div className="w-full h-full">
      <div
        ...
        className="max-w-lg  w-full mx-auto my-auto p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
        role="alert"
      >
        <div className="flex items-center">
          ...
          <h3 className="text-lg font-medium">Payment Cancel</h3>
        </div>
        <div className="mt-2 mb-4 text-sm">Please, Try Again</div>
        <div className="flex">
          <button
            type="button"
